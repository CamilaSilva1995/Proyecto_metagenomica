...
datakraken10 = pd.read_csv('data/10lineas_kraken.tsv',sep='\t',header=None, names=["c-clasificado", "read_ID","taxon_ID_kraken","length_pb","LCA_taxonomic"])
...
datakaiju10 = pd.read_csv('data/10lineas_kaiju.tsv',sep='\t',header=None, names=["c-clasificado", "read_ID","taxon_ID_kaiju"])
...
datakraken10c = pd.read_csv('data/10lineascola_kraken.tsv',sep='\t',header=None, names=["c-clasificado", "read_ID","taxon_ID_kraken","length_pb","LCA_taxonomic"])
...
datakaiju10c = pd.read_csv('data/10lineascola_kaiju.tsv',sep='\t',header=None, names=["c-clasificado", "read_ID","taxon_ID_kaiju2"])
...
datakraken101 = datakraken10.drop(["length_pb","LCA_taxonomic"], axis=1)
#datakaiju101 = datakaiju10.drop(['c-clasificado'], axis=1)
datakaiju101 = datakaiju10
datakraken102 = datakraken10c.drop(["length_pb","LCA_taxonomic"], axis=1)
#datakaiju102 = datakaiju10c.drop(['c-clasificado'], axis=1)
datakaiju102 = datakaiju10c
...
datakraken = pd.read_csv('data/21_10_datos_completos/EG1BMAA_kraken.tsv',sep='\t',header=None, names=["c-clasificado", "read_ID","taxon_ID_kraken","length_pb","LCA_taxonomic"]) 
datakaiju = pd.read_csv('data/21_10_datos_completos/EG1BMAA_kaiju.tsv',sep='\t',header=None, names=["c-clasificado","read_ID","taxon_ID_kaiju"])


# In[6]:


datakrakenall = datakraken.drop(["length_pb","LCA_taxonomic"], axis=1)
datakaijuall = datakaiju
